...
module.exports = {
  ...
  lexemes: [
    ...
    // Figure with optional caption field
    {
      token: 'figure',
      pattern: [
        {token: 'image-open'},
        {token: 'text', repeat: true, optional: true},
        {token: 'close-bracket'},
        {token: 'open-bracket'},
        {token: 'text', repeat: true, optional: true},
        {token: 'close-bracket'},
    ...
    // Figure with caption and image link
    {
      token: 'figure',
      pattern: [
        {token: 'image-open'},
      ...
      attributeValue: function (history, input) {
        ...
        history.forEach(function (visit) {
          ...
          if (token === 'close-bracket') {
            ...
            attrVal[stage] += inputAttrVal.trim();
          }
        });
    ...
    // Figure with photographer and blogger fields
    {
      token: 'blogImage',
      pattern: [
        // Title text
      ...
      attributeValue: function (history, input) {
        ...
        history.forEach(function (visit) {
          ...
          if (token === 'close-bracket' || token === 'newline') {
            // Skip
          }
          else if (token === 'double-quote') {
            stage = 'alt';
    ...
    // Figure with photographer and blogger fields, this variant includes a link
    // for the image
    {
      token: 'blogImage',
      pattern: [
